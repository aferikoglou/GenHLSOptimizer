"""
Main script for optimizing HLS (High-Level Synthesis) kernel directives using
a multi-objective genetic algorithm (NSGA-II) and Vitis HLS. The script:
1. Parses user arguments
2. Loads the kernel source and info
3. Configures the optimization problem
4. Runs the genetic algorithm
5. Exports Pareto-optimal solutions
...
def str2bool(v):
    """
    Convert string arguments to boolean for argparse.
    """
