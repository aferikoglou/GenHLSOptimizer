...
#pragma HLS array_partition variable=local_searchSpace_0 cyclic factor=2 dim=1
L9:    INTERFACE_WIDTH local_searchSpace_1[NUM_PT_IN_BUFFER*NUM_FEATURE/WIDTH_FACTOR];
#pragma HLS array_partition variable=local_searchSpace_1 cyclic factor=2 dim=1
	
L10:    INTERFACE_WIDTH local_distance_0[NUM_PT_IN_BUFFER/WIDTH_FACTOR];
#pragma HLS array_partition variable=local_distance_0 cyclic factor=4 dim=1
L11:    INTERFACE_WIDTH local_distance_1[NUM_PT_IN_BUFFER/WIDTH_FACTOR];
#pragma HLS array_partition variable=local_distance_1 cyclic factor=4 dim=1
