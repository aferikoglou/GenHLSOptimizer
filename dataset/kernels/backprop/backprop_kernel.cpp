...
L6:    float ly_buf_x[TILE_SIZE];
L7:    float ly_buf_y[TILE_SIZE];
L8:    float ly_buf_z[TILE_SIZE];

L9:    float w_buf_x[TILE_SIZE][16];

L10:    float w_buf_y[TILE_SIZE][16];

L11:    float w_buf_z[TILE_SIZE][16];

L12:    float oldw_buf_x[TILE_SIZE][16];

L13:    float oldw_buf_y[TILE_SIZE][16];

L14:    float oldw_buf_z[TILE_SIZE][16];

L15:	for(int loop = 0; loop < 1000; ++loop) {
