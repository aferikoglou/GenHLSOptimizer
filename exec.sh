...
run_func() {
	...
	TIMEOUT=600 # in sec
	python3 automatic_optimizer.py --INPUT_SOURCE_PATH $INPUT_SOURCE_PATH --INPUT_SOURCE_INFO_PATH $INPUT_SOURCE_INFO_PATH --DB_NAME $DB_NAME --SRC_EXTENSION $SRC_EXTENSION --GENERATIONS 2 --THREADS 5 --TIMEOUT $TIMEOUT
